...
**Mocha** is an Elixir/Phoenix 1.3 application that hosts real-time **Tambola** (Housie/Bingo) games with WebSocket-based communication. Players join games via Google OAuth, watch numbers being auto-picked at configurable intervals, and compete for prizes. The README claims support for 100K concurrent games and 1M+ users on 16GB RAM.
...
- **Context pattern (DDD):** `Mocha.Accounts` (users, credentials) and `Mocha.Housie` (games, prizes, servers)
- **OTP processes:** GenServer per game (`Mocha.Housie.Server`), Agent per board (`Mocha.Housie.Board`)
...
- **File:** `lib/mocha_web/channels/game_socket.ex:23-25`
...
- **File:** `lib/mocha_web/controllers/auth_controller.ex:30,38`
...
- **File:** `lib/mocha_web/router.ex:15-19`
...
- **File:** `lib/mocha_web/controllers/api/game_controller.ex:18-19`
...
- **File:** `lib/mocha_web/channels/public_channel.ex:16-18`
...
- **File:** `lib/mocha/housie/housie.ex:17`
...
- **File:** `lib/mocha/housie/server.ex:66-76`
...
- **File:** `lib/mocha/housie/server.ex:72-76`
...
- **File:** `lib/mocha/housie/board.ex:20-29`
...
- **File:** `lib/mocha/housie/board.ex:21`
...
- **File:** `lib/mocha/housie/server.ex:123-126`
...
- **File:** `lib/mocha/housie/housie.ex:31-33, 36-38, 54-57`
...
- **File:** `lib/mocha_web/controllers/api/game_controller.ex:109-113`
...
- **File:** `lib/mocha_web/plug/set_user.ex:14`
...
- **File:** `lib/mocha_web/channels/game_channel.ex:8-9,18`
...
- **File:** `lib/mocha_web/controllers/api/game_controller.ex:48,64,79,105,117`
...
- **File:** `lib/mocha_web/router.ex:32-34`
...
- **File:** `lib/mocha_web/router.ex:30`
...
- **File:** `lib/mocha_web/controllers/api/game_controller.ex:73,102`
...
- **File:** `lib/mocha_web/controllers/api/game_controller.ex:96-103`
...
#### Q4. Dead code
- **File:** `lib/mocha_web/helpers/user_from_auth.ex`
